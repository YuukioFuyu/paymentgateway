...
namespace YuukioFuyu\Paymentgateway\Base\Gateways;

use YuukioFuyu\Paymentgateway\Base\PaymentGatewayBase;
...
* */
    ...
    protected function getPaymentProvider($args){
        ...
        $config = [
            ...
            'payment_action' => 'Sale',
            'currency'       => config('paymentgateway.global_currency'),
       ...
       $provider = $this->getPaymentProvider($args);
        ...
        $order = $provider->createOrder([
            ...
            "purchase_units"=> [
                0 => [
                    "amount"=> [
                        "currency_code"=> config('paymentgateway.global_currency'),
                        "value"=> $args['amount']
                    ]
                ]
            ],
